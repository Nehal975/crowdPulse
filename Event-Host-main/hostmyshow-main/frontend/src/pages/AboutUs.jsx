...
const PROFILE_NEHAL = "https://media.licdn.com/dms/image/v2/D4D03AQHPVOtEVdufkA/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1709465192531?e=1757548800&v=beta&t=TOWVk50k32L_7v2HThlg0OFtP49zEICP2aAm0W1NU-k";
      ...
      <div className="w-full max-w-4xl glass rounded-3xl shadow-2xl p-10 backdrop-blur-md bg-white/10 border border-blue-400/20">
        ...
        <section className="mb-10">
          ...
          <p className="text-blue-100 mb-2 text-lg">
            CrowdPulse is a modern event management and ticketing platform designed for hackathons, live shows, and conferences. It allows organizers to create, manage, and promote events, while attendees can discover, book, and enjoy seamless event experiences.
          </p>
        </section>
        {/* Tech Stack */}
        <section className="mb-10">
        ...
        <section className="flex flex-col md:flex-row gap-8 justify-center items-stretch">
          ...
          <div className="flex-1 bg-blue-900/40 rounded-2xl p-6 flex flex-col items-center shadow-lg hover:scale-[1.03] transition-transform duration-200">
            <img src={PROFILE_NEHAL} alt="Nehal Singh" className="w-24 h-24 rounded-full border-4 border-blue-400 shadow-md mb-4 object-cover" />
            <p className="text-xl font-bold text-white mb-1">Nehal Singh</p>
            <p className="text-blue-100 mb-1">Full Stack Developer</p>
            <p className="text-blue-100 text-center">Passionate about building modern web applications, UI/UX, and solving real-world problems with technology.</p>
          </div>
          {/* Aakash Yadav */}
          <div className="flex-1 bg-blue-900/40 rounded-2xl p-6 flex flex-col items-center shadow-lg hover:scale-[1.03] transition-transform duration-200">
            <img src={PROFILE_SAKSHI} alt="Aakash Yadav" className="w-24 h-24 rounded-full border-4 border-blue-400 shadow-md mb-4 object-cover" />
            <p className="text-xl font-bold text-white mb-1">Aakash Yadav</p>
            <p className="text-blue-100 mb-1">Full Stack Developer</p>
            <p className="text-blue-100 text-center">Focused on building web applications with strength in backend development, databases, and secure systems.</p>
          </div>
          {/* Kumar Saurabh */}
          <div className="flex-1 bg-blue-900/40 rounded-2xl p-6 flex flex-col items-center shadow-lg hover:scale-[1.03] transition-transform duration-200">
            <img src={PROFILE_NEHAL} alt="Kumar Saurabh" className="w-24 h-24 rounded-full border-4 border-blue-400 shadow-md mb-4 object-cover" />
            <p className="text-xl font-bold text-white mb-1">Kumar Saurabh</p>
            <p className="text-blue-100 mb-1">Full Stack Developer</p>
            <p className="text-blue-100 text-center">Enjoys turning real-world challenges into scalable solutions and thrives in collaborative, tech-driven environments.</p>
          </div>
          {/* Nishu Kaushik */}
          <div className="flex-1 bg-blue-900/40 rounded-2xl p-6 flex flex-col items-center shadow-lg hover:scale-[1.03] transition-transform duration-200">
            <img src={PROFILE_SAKSHI} alt="Nishu Kaushik" className="w-24 h-24 rounded-full border-4 border-blue-400 shadow-md mb-4 object-cover" />
            <p className="text-xl font-bold text-white mb-1">Nishu Kaushik</p>
            <p className="text-blue-100 mb-1">Full Stack Developer</p>
            <p className="text-blue-100 text-center">Always eager to learn and collaborate on innovative projects that make a difference.</p>
          </div>
        </section>
      </div>
    </div>
