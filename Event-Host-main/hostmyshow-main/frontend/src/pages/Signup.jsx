...
const Signup = () => {
  ...
  // Handle interest toggle for attendees
      ...
      <div className="relative backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-10 shadow-2xl w-[960px] flex justify-between gap-24">
        ...
        <div className="relative z-10 w-full lg:w-1/2">
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            {/* Interests selection - only for Attendees */}
            {formData.role === "Attendee" && (
              <div className="space-y-3">
                <label className="text-white/70 text-sm block">Select your interests (optional)</label>
