        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="flex gap-4 flex-wrap justify-center md:justify-start">
            ...
            <button 
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg transition-colors shadow"
            >
              Buy Tickets
            </button>
          ...
          {loadingReviews ? (
            ...
            reviews.map((review, index) => (
              <div key={index} className="bg-white/5 p-3 rounded-lg border border-white/10">
                <span className="text-lg text-blue-400 mt-1 block">{review.username || review.user_id?.username || 'Anonymous'}</span>
