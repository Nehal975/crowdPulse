...
const HostAnalysis = lazy(() => import('./pages/organizer/HostAnalysis'));
...
const ProtectedOrganizerRoute = ({ children }) => {
  ...
  // Allow both Organizer and Admin to access
...
const ProtectedAttendeeRoute = ({ children }) => {
  ...
  // Allow both Attendee and Admin to access
...
const LoaderBackend = () => (
  <div className="min-h-screen flex items-center justify-center bg-gray-900">
    <div className="loader"></div>
    <p className='text-white text-2xl ml-4'>Backend is Starting Just wait for a while...</p>
  </div>
);
